...
const recetasArr = [
    {
        ...
        pasos:[
            ...
            {Paso: "Añadir los huevos uno a uno y la esencia de vainilla."},
            {Paso: "Incorporar suavemente la avena, la Maizena, la levadura y la sal."},
            {Paso: "Mezclar todo hasta conseguir una mezcla uniforme."},
            {Paso: "Hacer bolitas con las manos, aplastarlas y llevarlas a una bandeja para horno forrada con papel para hornear."},
            {Paso: "Hornear 15 minutos a fuego medio o hasta que empiecen a dorarse los bordes."},
            {Paso: "Decorar con chocolate derretido, dejar enfriar y servir."},
        ],
    ...
    },
    {
        ...
        pasos:[
            ...
            {Paso: "Pinta el fondo de la sartén con el AOVE con la ayuda de un pincel de cocina o un trozo de papel absorbente para evitar poner demasiado aceite. Verte un poco de la mezcla de tal manera que cubra el fondo de la sartén."},
            {Paso: "Cuando los bordes se hayan hecho y empiece a estar algo más consistente la mezcla se le da la vuelta y se espera a que se haga por el otro lado antes de sacarla."},
            {Paso: "Puedes rellenar la crepe con Nutella Fitness, mermelada light de cualquier sabor, miel o sola. Y a disfrurar!"}
        ],
    ...
    },
    {
        ...
        pasos:[
            ...
            {Paso: "Mezclar en el bol los ingredientes secos para la masa."},
            {Paso: "Batir el huevo y la nata hasta integrarlos. Añade la mantequilla derretida (pero no ardiente)."},
            {Paso: "Añade a la mezcla los ingredientes secos y batir todo hasta que quede una masa homogénea."},
            {Paso: "Verter en los moldes para muffins y decorar con los arándanos."},
            {Paso: "Hornear por 20 minutos hasta que se comiencen a dorar."}
        ],
    ...
    },
    {
        ...
        pasos:[
            ...
            {Paso: "En un cazo pon el queso crema, la nata, el azúcar y los sobres de cuajada. Tritura con la ayuda de la batidora o “túrmix” y lleva al fuego a calentar removiendo constantemente y sin que llegue a hervir a fuego medio-alto."},
            {Paso: "Cuando esté a punto de hervir saca el cazo del fuego y rellena los tarros que tenías guardados en la nevera con cuidado. Dale unos golpecitos para que la mezcla se reparta y déjalos templar a temperatura ambiente. Una vez fríos mételos en la nevera mínimo 6 horas."},
            {Paso: "En el momento de servir la tarta de queso echa una cucharada de mermelada de frutos rojos, higos, arándanos… La que más te guste!"}
        ],
    ...
    },
    {
        ...
        pasos:[
            ...
            {Paso: "Bate los huevos con el azúcar hasta que el azúcar se mezcle bien y añade el chocolate, y luego la harina de arroz y el cacao."},
            {Paso: "El último paso es incorporar las nueces picadas."},
            {Paso: "Coloca en una placa para horno o en un molde cuadrado, forrándolo previamente con papel sulfurizado, y hornea a fuego medio (180ºC) hasta que esté cocido en su interior durante unos 30 minutos. Una vez pasado el tiempo pinchamos con un palillo en el centro para ver si sale limpio, momento en el que podemos retirar del horno."},
        ],
    ...
    },
    {
        ...
        pasos:[
            ...
            {Paso: "Al caramelo sobrante, añade unas fresas limpias y picadas. Cuando se embadurnen, añade el chorrito de vinagre. Dale un hervor, retira a un bol y reserva."},
            {Paso: "Para hacer el flan, mezcla los huevos batidos y el queso. Mezcla bien y sigue añadiendo la leche condensada, la miel y la leche. Mezcla todo bien y vierte la preparación en el molde. Cocina en el horno al baño maría a 165º durante unos 40 minutos. Deja enfriar antes de desmoldar."},
            {Paso: "Monta la nata ligeramente con unas varillas. Desmolda el flan de queso y miel y sirve acompañado de las fresas y la nata. Adorna con unas hojas de menta."},
        ],
    ...
    },
    {
        ...
        pasos:[
            ...
            {Paso: "Una vez que la leche está infusionada suficientemente de vainilla, retiraremos la vaina y añadiremos poco a poco a la mezcla de yemas."},
            {Paso: "Después lo pondremos todo junto de nuevo en la cacerola a fuego medio sin parar de mezclar con una cuchara de madera hasta que espese.Esta etapa puede durar al menos 10 min.Tapar con film transparente. Dejar enfriar"},
            {Paso: "Estira la masa sablé, y con la ayuda de un bol, corta 4 círculos de masa."},
            {Paso: "Cubre los moldes con la base de sablé (previamente engrasados en mantequilla). Pinchar con un tenedor el fondo.Refrigerar durante 30 min y después hornear 20 min a 180°C."},
            {Paso: "Una vez que el fondo de las tartaletas y la crema pastelera están fríos, aplicaremos una generosa capa de crema pastelera en cada tartaleta."},
            {Paso: "Coloca de la mejor manera las frambuesas y espolvorear azúcar glas por encima. Y listo!!!"}
        ],
    ...
    },
    {
        ...
        pasos:[
            ...
            {Paso: "Mezclamos por un lado los ingredientes secos. Tamizamos la harina, el bicarbonato, la levadura en polvo y las especias (canela, el clavo, la nuez moscada y jengibre) en un recipiente grande."},
            {Paso: "Después añadimos el azúcar moreno y los huevos en otro bol y batimos hasta que se forme espuma. Incorporamos una mezcla de un bol a otro, añadimos la zanahoria y la mantequilla que hemos derretido en el microondas. Mezclamos hasta que quede una masa homogénea."},
            {Paso: "Metemos el molde en la bandeja media del horno a 180º C con calor arriba y abajo. El tiempo de cocción será  aproximadamente de 60-70 minutos, o hasta que lo pinchemos con un tenedor y veamos que sale limpio. Cuando lleve 30 minutos en el horno (se verá que ya tiene un poco de costra, que empieza a cuajar) ponemos un poquito de papel de aluminio para tapar la superficie y evitar que se nos queme. Los últimos 5-8 minutos la dejamos destapada para que pille color."},
            {Paso: "Una vez transcurrido el tiempo, sacamos el bizcocho y lo dejamos enfriar en el molde sin desmoldar durante unos 10 minutos, para posteriormente pasarlo al plato donde lo vayamos a presentar con la crema de queso. Lo dejamos enfriar sobre una rejilla de horno."},
            {Paso: "Vamos a preparar la cobertura, no es más que un buttercream. Es muy sencilla, ya la habéis visto en el blog en varias ocasiones y que además nos vale de relleno."},
            {Paso: "Mezclamos la mantequilla, que estará a temperatura ambiente con el queso Mascarpone y la esencia de vainilla, cuando estén mezclados, añadimos el azúcar. Montamos la nata y la incorporamos a la mezcla anterior con movimientos envolventes."},
            {Paso: "Cortamos el bizcocho en tres bases, si creéis que se os va a romper, lo cortáis directamente por el centro. Rellenamos con la cobertura primero en una de las bases de bizcocho. Colocamos la otra mitad del bizcocho encima y procedemos a cubrir con otra capa y otra base de bizcocho."},
            {Paso: "Luego vamos con la tarta entera, primero una capa finita para eliminar las migas que salgan. Para cubrir la tarta finalmente, necesitaremos dejarla enfriar en la nevera como mínimo 1 hora. Sacamos de la nevera y le ponemos una capa más gordita con la ayuda de una espátula. Repasamos toda la superficie y esparcimos unos pocos frutos secos (los que más os gusten) por encima. En caso de que hagamos un layer cake y también necesitemos cobertura para rellenar el pastel, tendremos que doblar la cantidad."},
        ],
